  ...
  return (
    <div className="flex-1 bg-slate-50 text-slate-900 flex flex-col justify-center items-center px-4 py-10 relative overflow-hidden">
      ...
      <div className="w-full max-w-md mb-6 flex justify-between items-center z-10">
        ...
        <span className="text-[10px] font-mono uppercase tracking-widest text-indigo-700 bg-indigo-50 border border-indigo-200 px-2 py-0.5 rounded-full flex items-center gap-1 font-bold">
          <Radio className="w-2.5 h-2.5 text-indigo-600 animate-pulse" /> Live Mode
        </span>
      </div>
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-8 shadow-sm relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Zero-Trust Sign In</h1>
        ...
        <div className="mt-6 pt-6 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-500">
            Need an account?{' '}
            <Link href="/register" className="text-indigo-600 hover:text-indigo-700 font-semibold underline underline-offset-4">
              Enroll Here
            </Link>
          </p>
        </div>
